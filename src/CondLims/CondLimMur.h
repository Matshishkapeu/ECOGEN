...
class CondLimMur : public CondLim
{
  public:
    CondLimMur();
    CondLimMur(const CondLimMur& Source, const int lvl = 0); //Constructeur de copie (utile pour AMR)
    CondLimMur(int numPhysique);
    virtual ~CondLimMur();
    ...
    virtual int quiSuisJe() const { return 2; };
