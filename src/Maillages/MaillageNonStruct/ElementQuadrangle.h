...
public:
  ...
  virtual void attributFaceLimite(const Coord *noeuds, FaceNS **faces, const int &indiceMaxFaces);
...
private:
  ...
  static const int NOMBREFACES; /* ici il s'agit du nombre de segments*/
