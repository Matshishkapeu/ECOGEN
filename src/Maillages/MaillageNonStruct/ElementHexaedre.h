...
#ifndef ELEMENTHEXAEDRE_H
#define ELEMENTHEXAEDRE_H

#include "ElementNS.h"
#include "FaceQuadrangle.h"

class ElementHexaedre : public ElementNS
{
public:
  ElementHexaedre();
  virtual ~ElementHexaedre();

  virtual void construitFaces(const Coord *noeuds, FaceNS **faces, int &indiceMaxFaces, int** facesTemp, int* sommeNoeudsTemp); //Pour tests
