...
void FaceQuadrangle::calculSurface(const Coord *noeuds)
{
  //Atention utilisation des numerotation de noeud d origine pour assurer le calcul des surfaces
  //une diagonale :
...
void FaceQuadrangle::calculRepere(const Coord *noeuds, const int &numNoeudAutre, ElementNS *elementVoisin)
{
