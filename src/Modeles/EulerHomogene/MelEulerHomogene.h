...
#ifndef MELEULERHOMOGENE_H
#define MELEULERHOMOGENE_H

#include <vector>
#include "../Melange.h"

class MelEulerHomogene : public Melange
{
public:
  MelEulerHomogene();
  MelEulerHomogene(tinyxml2::XMLElement *materiau, std::string nomFichier);
  virtual ~MelEulerHomogene();
